...
const DoctorSmirnova = () => {
  useEffect(() => {
    document.title = "Смирнова Елена Викторовна - врач-терапевт ИзиМед";
    
    const metaDescription = document.querySelector('meta[name="description"]');
    if (metaDescription) {
      metaDescription.setAttribute("content", "Смирнова Елена Викторовна - терапевт, специалист по оформлению медицинских справок. 15 лет опыта работы в клинике ИзиМед.");
    } else {
      const meta = document.createElement('meta');
      meta.name = "description";
      meta.content = "Смирнова Елена Викторовна - терапевт, специалист по оформлению медицинских справок. 15 лет опыта работы в клинике ИзиМед.";
      ...
      <main className="container py-12">
        <div className="max-w-4xl mx-auto">
          <nav className="flex items-center gap-2 text-sm mb-6">
            ...
            <Icon name="ChevronRight" size={16} className="text-muted-foreground" />
            <span className="text-muted-foreground">Смирнова Е.В.</span>
          </nav>

          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
            <div className="md:col-span-1">
              <img 
                src="https://cdn.poehali.dev/projects/77d582ab-51e7-4922-90af-fd5f275d2b1f/files/a3976503-a615-45ff-8639-91dc275de51c.jpg" 
                alt="Смирнова Елена Викторовна" 
                className="w-full rounded-lg shadow-lg"
              />
            </div>
            
            <div className="md:col-span-2">
              <h1 className="text-3xl font-bold mb-2">Смирнова Елена Викторовна</h1>
              <p className="text-xl text-primary mb-4">Врач-терапевт</p>
              <div className="flex flex-wrap gap-2 mb-6">
                <Badge variant="secondary">15 лет опыта</Badge>
                <Badge variant="outline">Медицинские справки</Badge>
                ...
                <CardContent>
                  <div className="space-y-3">
                    <div className="flex justify-between py-2 border-b">
                      ...
                      <span className="font-medium">1979</span>
                    </div>
                    <div className="flex justify-between py-2 border-b">
                      <span className="text-muted-foreground">Стаж работы:</span>
                      <span className="font-medium">15 лет</span>
                    </div>
            ...
            <Card>
              ...
              <CardContent>
                <div className="space-y-4">
                  <div>
                    <p className="font-semibold text-lg">Первый Московский государственный медицинский университет им. И.М. Сеченова</p>
                    <p className="text-muted-foreground">Лечебный факультет, специальность "Лечебное дело"</p>
                    <p className="text-sm text-muted-foreground">1997-2003 гг.</p>
                  </div>
                  <div className="pt-4 border-t">
                    <p className="font-semibold">Интернатура по специальности "Терапия"</p>
                    <p className="text-muted-foreground">Городская клиническая больница №1</p>
                    <p className="text-sm text-muted-foreground">2003-2004 гг.</p>
                  </div>
                </div>
              </CardContent>
            </Card>
              ...
              <CardContent>
                <div className="space-y-4">
                  <div>
                    ...
                    <p className="text-muted-foreground">Врач-терапевт, специалист по оформлению медицинских справок</p>
                    ...
                    <ul className="mt-2 ml-6 list-disc text-sm text-muted-foreground space-y-1">
                      <li>Оформление справок 086/у, 095/у, 003-В/у</li>
                      <li>Проведение профилактических осмотров</li>
                      <li>Консультации по вопросам здоровья</li>
                      <li>Более 5000 успешно оформленных справок</li>
                    </ul>
                  </div>
                  <div className="pt-4 border-t">
                    <p className="font-semibold">Городская поликлиника №45</p>
                    <p className="text-muted-foreground">Участковый терапевт</p>
                    <p className="text-sm text-muted-foreground">2004-2015 гг. (11 лет)</p>
                  </div>
                </div>
              </CardContent>
            </Card>
              ...
              <CardContent>
                <div className="space-y-3">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <p className="font-medium">Современные аспекты профилактической медицины</p>
                  ...
                  <div className="flex items-start gap-3">
                    <Icon name="CheckCircle2" className="text-primary mt-1" size={18} />
                    <div>
                      <p className="font-medium">Медицинское освидетельствование и экспертиза</p>
              ...
              <CardContent>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="p-4 rounded-lg bg-muted/30">
                    ...
                    <p className="text-sm text-muted-foreground mb-2">Для поступления в учебные заведения</p>
                  ...
                  <div className="p-4 rounded-lg bg-muted/30">
                    ...
                    <p className="text-sm text-muted-foreground mb-2">О временной нетрудоспособности</p>
                  ...
                  <div className="p-4 rounded-lg bg-muted/30">
                    ...
                    <p className="text-sm text-muted-foreground">О состоянии здоровья</p>
                  </div>
                  <div className="p-4 rounded-lg bg-muted/30">
                    <h3 className="font-semibold mb-2">Профосмотры</h3>
                    <p className="text-sm text-muted-foreground">Профилактические медосмотры</p>
                  </div>
                </div>
              </CardContent>
            </Card>
                ...
                <div className="flex flex-col md:flex-row items-center gap-6">
                  <div className="flex-1">
                    ...
                    <p className="text-muted-foreground mb-4">
                      Запишитесь на приём к Смирновой Елене Викторовне для получения медицинской справки
                    </p>
                  </div>
